...
export function GridGallery({ photo }: GridGalleryProps) {
  ...
  return (
    <div className='fade-in-0 slide-in-from-bottom-2 grid-item-responsive grid-item-smooth aspect-square w-full animate-in duration-500'>
      <div className='group relative h-full w-full overflow-hidden rounded-lg bg-gray-100 shadow-md transition-all duration-300 ease-out hover:shadow-xl md:shadow-lg md:hover:shadow-2xl dark:bg-gray-800'>
        {isClient && (
          <Image
            placeholder='blur'
