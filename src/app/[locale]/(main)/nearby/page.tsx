...
export default function NearbyPage() {
  ...
  const nearbyPhotosQuery = api.photo.getNearbyPhotosInfinite.useInfiniteQuery(
    {
      latitude: latitude!,
      longitude: longitude!,
      ...
      <BaseLayout>
        <div className='flex h-[60vh] w-full flex-col items-center justify-center gap-4'>
          ...
          <p className='text-gray-500 text-sm'>
            Please allow location permission to show nearby photos
          </p>
        </div>
      </BaseLayout>
    )
  ...
  if (!hasLocation) {
    return (
      <BaseLayout>
        <div className='flex h-[60vh] w-full items-center justify-center'>
          <p>Location permission required to show nearby photos</p>
        </div>
      </BaseLayout>
    )
  }
  ...
  return (
    <BaseLayout>
      <Gallery queryResult={nearbyPhotosQuery} />
    </BaseLayout>
  )
}
